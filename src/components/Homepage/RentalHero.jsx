  ...
  return (
    <div className="w-full bg-[#fbf9f5] text-[#111827] overflow-x-hidden">
      ...
      <section className="relative w-full h-[75vh] sm:h-[82vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-black select-none">
        ...
        >
          <img
            ...
            alt="Trucks Fleet"
            className="w-full h-full object-cover object-bottom brightness-75 contrast-95"
          />
        </motion.div>
      ...
      <section className="w-full py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <motion.div variants={cardFadeUp} className="group bg-white rounded-3xl p-8 border border-neutral-200/80 shadow-sm flex flex-col items-center text-center hover:shadow-[0_12px_35px_rgba(197,154,83,0.18)] hover:-translate-y-2 hover:border-[#dfb76c] transition-all duration-300 cursor-pointer">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#805923] via-[#b38843] to-[#6a491c] flex items-center justify-center text-white mb-6 shadow-sm group-hover:scale-110 group-hover:brightness-110 transition-transform duration-300">
              <CreditCard size={26} />
            </div>
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          <div className="px-4 py-1.5 rounded-full bg-[#835a22] text-white text-xs font-semibold tracking-wide shadow-sm">
      ...
      <section className="w-full py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <motion.div 
          ...
          className="flex justify-center mb-6"
        >
          <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#835a22] text-white text-xs font-semibold shadow-sm">
            <ShieldCheck size={16} />
